...
-- -----------------------------------------------------
-- Table `DATABASE_C3`.`articolo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DATABASE_C3`.`articolo` (
...
-- -----------------------------------------------------
-- Table `DATABASE_C3`.`prodottoInVendita`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DATABASE_C3`.`prodottoInVendita` (
  `prezzo` DOUBLE NOT NULL,
  `quantita` INT NOT NULL,
  `prodotto_ID` VARCHAR(8) NOT NULL,
  `ID` VARCHAR(8) NOT NULL,
  `commerciante_ID` VARCHAR(8) NOT NULL,
  INDEX `fk_prodottoInVendita_prodotto_idx` (`prodotto_ID` ASC) VISIBLE,
  PRIMARY KEY (`ID`),
  INDEX `fk_prodottoInVendita_commerciante1_idx` (`commerciante_ID` ASC) VISIBLE,
  CONSTRAINT `fk_prodottoInVendita_prodotto`
    FOREIGN KEY (`prodotto_ID`)
    REFERENCES `DATABASE_C3`.`articolo` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `DATABASE_C3`.`categoria`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DATABASE_C3`.`categoria` (
  `ID` VARCHAR(8) NOT NULL,
  `nome` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `DATABASE_C3`.`corriere` (
  ...
  `email` VARCHAR(45) NOT NULL,
  `indirizzo` VARCHAR(45) NULL,
  `ragione sociale` VARCHAR(45) NOT NULL,
  `stato` ENUM("DISPONIBILE", "NON_DISPONIBILE") NOT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE INDEX `ragione sociale_UNIQUE` (`ragione sociale` ASC) VISIBLE,
  UNIQUE INDEX `email_UNIQUE` (`email` ASC) VISIBLE,
  UNIQUE INDEX `username_UNIQUE` (`username` ASC) VISIBLE,
  UNIQUE INDEX `ID_UNIQUE` (`ID` ASC) VISIBLE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `DATABASE_C3`.`tracking`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DATABASE_C3`.`tracking` (
  `ID` VARCHAR(8) NOT NULL,
  `stato` ENUM("IN_ELABORAZIONE", "PRESO_IN_CARICO", "IN_TRANSITO", "IN_CONSEGNA", "CONSEGNATO") NOT NULL,
  `ritiro_ID` VARCHAR(8) NOT NULL,
  PRIMARY KEY (`ID`),
  INDEX `fk_tracking_ritiro1_idx` (`ritiro_ID` ASC) VISIBLE,
  CONSTRAINT `fk_tracking_ritiro1`
...
-- -----------------------------------------------------
-- Table `DATABASE_C3`.`ritiro_has_prodotti`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DATABASE_C3`.`ritiro_has_prodotti` (
  ...
  CONSTRAINT `fk_prodottoInVendita_has_ritiro_prodottoInVendita1`
    ...
    REFERENCES `DATABASE_C3`.`prodottoInVendita` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `DATABASE_C3`.`prodotto_has_categoria`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DATABASE_C3`.`prodotto_has_categoria` (
  `prodotto_ID` VARCHAR(8) NOT NULL,
  `categoria_ID` VARCHAR(8) NOT NULL,
  PRIMARY KEY (`prodotto_ID`, `categoria_ID`),
  INDEX `fk_prodotto_has_categoria_categoria1_idx` (`categoria_ID` ASC) VISIBLE,
  INDEX `fk_prodotto_has_categoria_prodotto1_idx` (`prodotto_ID` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_prodotto_has_categoria_categoria1`
    ...
    REFERENCES `DATABASE_C3`.`categoria` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `DATABASE_C3`.`commerciante_has_categoria`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DATABASE_C3`.`commerciante_has_categoria` (
  `commerciante_ID` VARCHAR(8) NOT NULL,
  `categoria_ID` VARCHAR(8) NOT NULL,
  PRIMARY KEY (`commerciante_ID`, `categoria_ID`),
  INDEX `fk_commerciante_has_categoria_categoria1_idx` (`categoria_ID` ASC) VISIBLE,
  INDEX `fk_commerciante_has_categoria_commerciante1_idx` (`commerciante_ID` ASC) VISIBLE,
  CONSTRAINT `fk_commerciante_has_categoria_commerciante1`
    FOREIGN KEY (`commerciante_ID`)
    REFERENCES `DATABASE_C3`.`commerciante` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_commerciante_has_categoria_categoria1`
    FOREIGN KEY (`categoria_ID`)
    REFERENCES `DATABASE_C3`.`categoria` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `DATABASE_C3`.`promozione_has_prodottoInVendita`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DATABASE_C3`.`promozione_has_prodottoInVendita` (
...
-- -----------------------------------------------------
-- Table `DATABASE_C3`.`promozione_has_commerciante`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DATABASE_C3`.`promozione_has_commerciante` (
  `promozione_ID` VARCHAR(8) NOT NULL,
  `commerciante_ID` VARCHAR(8) NOT NULL,
  PRIMARY KEY (`promozione_ID`, `commerciante_ID`),
  INDEX `fk_promozione_has_commerciante_commerciante1_idx` (`commerciante_ID` ASC) VISIBLE,
  INDEX `fk_promozione_has_commerciante_promozione1_idx` (`promozione_ID` ASC) VISIBLE,
  CONSTRAINT `fk_promozione_has_commerciante_promozione1`
    FOREIGN KEY (`promozione_ID`)
    REFERENCES `DATABASE_C3`.`promozione` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_promozione_has_commerciante_commerciante1`
    FOREIGN KEY (`commerciante_ID`)
    REFERENCES `DATABASE_C3`.`commerciante` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `DATABASE_C3`.`puntoRitiro`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DATABASE_C3`.`puntoRitiro` (
  `ID` VARCHAR(8) NOT NULL,
  `username` VARCHAR(45) NOT NULL,
  `password` VARCHAR(45) NOT NULL,
  `email` VARCHAR(45) NOT NULL,
