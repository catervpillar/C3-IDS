...
public final class GestorePromozioni {
    ...
    public void creaPromozione(String nome, String IDCommerciante, List<String> listaIDProdotti, String descrizione, GregorianCalendar dataInizio, GregorianCalendar dataScadenza) {
//        Promozione promozione = new Promozione(nome, IDCommerciante, listaIDProdotti, descrizione, dataInizio, dataScadenza);
