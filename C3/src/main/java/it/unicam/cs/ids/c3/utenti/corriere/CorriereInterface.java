...
/**
 * Questa interfaccia è implementata da tutte le classi che devono gestire un singolo {@link Corriere}.
 */
public interface CorriereInterface {
    ...
    /**
     * Metodo getter per l'attributo stato.
     *
     * @return l'attributo stato.
     */
    StatoCorriere getStato();

    /**
     * Metodo setter per l'attributo stato.
     *
     * @param stato - Il nuovo attributo stato.
     */
